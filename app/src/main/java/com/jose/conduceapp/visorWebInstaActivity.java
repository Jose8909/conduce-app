...
public class visorWebInstaActivity extends AppCompatActivity {
    WebView miVisorWeb;
    String url = "https://www.instagram.com/falconcea/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_visor_web_insta);
