...
public class visorWebFaceActivity extends AppCompatActivity {
    WebView miVisorWeb;
    String url = "https://www.facebook.com/falconcea/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_visor_web_face);miVisorWeb = (WebView) findViewById(R.id.visorWeb);
